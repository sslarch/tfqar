...
Please feel free to contribute by [submitting a pull request]() or [opening an issue]() with suggestions.
...
tfqar %>% 
  ...
  text_transform(cells_body(vars(tfqa_description)), md_collapse) %>% 
  text_transform(cells_body(vars(r_function)), plain_list) %>% 
  fmt_markdown(vars(r_package, notes)) %>% 
